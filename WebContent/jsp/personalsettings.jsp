...
<body>
	...
	<form action="<%=request.getContextPath()%>/book/settings.do"
		method="post">
		<%
		...
		<div class="banking">
			<span> <strong>Personal Settings</strong></span>
			<table>
				<tr>
					<td><label>Enter the Threshold:</label></td>
					<td><input name="threshold" id="threshold" type="text"
